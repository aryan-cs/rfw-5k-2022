    ...
    return (
        ...
        <div>
            ...
            <div className = "Partners">
                ...
                {/* <img src = {process.env.PUBLIC_URL + "/assets/partners/rrpharmacy.png" }
                     onClick = {() => window.open("http://ranareaganpharmacy.com/", '_blank', 'noopener, noreferrer')} 
                     className = 'Partner-link' 
                     alt = "Rana-Reagan Pharmacy" 
                     rel = "noreferrer" 
                     target = "_blank" 
                     href = "http://ranareaganpharmacy.com/"/> */}

                {/* add mara pharmicy and addison pharmacy */}
